...
protected:
  ...
  SortedPairs sort_primitives_by_morton_code(
    const BoundingBox<Scalar>& global_bbox, const Vector3<Scalar>* centers, size_t primitive_count)
  {
...
#pragma omp for
      ...
      radix_sort.sort_in_parallel(sorted_morton_codes, unsorted_morton_codes,
        sorted_primitive_indices, unsorted_primitive_indices, primitive_count, bit_count * 3);
    }
