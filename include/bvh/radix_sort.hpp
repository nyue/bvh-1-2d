...
public:
  ...
  void sort_in_parallel(Key* bvh_restrict& keys, Key* bvh_restrict& keys_copy,
    Value* bvh_restrict& values, Value* bvh_restrict& values_copy, size_t count, size_t bit_count)
  {
